...
def plot_bar_stripplot_single(data, stats = None, y_title = "y title",
    ...
    num_groups = len(x_titles)
    new_palette = sns.color_palette(colormap, num_groups)
...
# def plot_bar_stripplot(data, x, y, group, stats = None, 
#                        plot_type = 'boxplot', colormap = 'mako',
#                        bar_palette = None,
#                        point_palette = None, 
#                        point_size = 9, line_thickness = 3, 
...
#         palette_div = 3
#         palette = sns.color_palette('mako', palette_div)
#         bar_palette.append(palette[0])
#         bar_palette.append(palette[palette_div-1])
    
#     if point_palette is None:
#         sf = 0.2
#         point_palette = [(x+sf, y+sf, z+sf) for x, y, z in bar_palette]
...
#     # # Adjust the gap between dodged points (massive bodge)
#     # for i, artist in enumerate(ax2.collections):
#     #     if i % 2 == 0:  # Adjust position of one group
#     #         artist.set_offsets(artist.get_offsets() - [-0.03, 0])  # Adjust the value for your desired gap
#     #     else:  # Adjust position of the other group
#     #         artist.set_offsets(artist.get_offsets() + [-0.03, 0])  # Adjust the value for your desired gap
